...
class Bio extends React.Component{
  render(){
    return(
      ...
      that lead to revenue. I wanted to be a superhero too.
      I was accepted into a highly competitive New York City Coding Bootcamp and
      Suddenly a whole world of possibilities opened up and all limitations were gone.
      I use my sales skills and coding skills every day to delight audiences and overcome challenges.</p>
      </div>
