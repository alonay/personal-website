        ...
        <table width="1000px" height="80%" >
          <tbody>
            <tr>
              ...
              <td>
                <label>StarSim</label><br/><ul id="language-points">
                  <li>Javascript</li>
                  <li>React</li>
                  <li>Postgres</li>
            ...
            <tr>
              ...
              <td><label>Pixed Up</label><br/><ul id="language-points">
                <li>Bootstrap</li>
                <li>Clarafai API</li>
                <li>Ruby</li>
                <li>Rails</li>
            ...
            <tr>
              ...
              <td><br/><br/><label>DateABase</label><br/><ul id="language-points">
                <li>Bootstrap</li>
                <li>Web Scarping</li>
                <li>React</li>
                <li>Simantic UI</li>
              ...
              and it is completely searchable. Choose to store anything from thier name to thier fit for the job or sorrority. But wait... what if you dont remember what your
